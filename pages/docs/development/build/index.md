...
```shell
sudo apt update && sudo apt install bc git curl zip m4 rsync python3-lxml python3-protobuf python3-yaml default-jdk-headless default-jre-headless libncurses5 libncurses5-dev libssl-dev
```
