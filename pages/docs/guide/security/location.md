...
Because GPS can be a drain on the battery or unavailable, especially when indoors, normal Android device use Google servers to estimate your location using other methods.
...
A normal Android device uses Google services for a variety of location functionality:
...
Airplane mode will turn off most radios in your device (carrier signal, Bluetooth, Wi-Fi) but not NFC or GPS, both of which can be used to track your location.
...
For more information, see [A Journey into Hexagon: Dissecting Qualcomm Basebands](https://www.slideshare.net/cisoplatform7/a-journey-into-hexagon-dissecting-qualcomm-basebands)
...
An app on your device might then keep track of your fine grain movements and then upload this history once you are back online. If you want location privacy, you should both turn on "Airplane Mode" and turn off "Location".

#### NFC

The range of NFC is not far, but public locations, such as retail stores, increasingly utilize NFC to track the movements of customers. For full location privacy, you should also disable NFC.
