...
For better Wi-Fi security, you should also use a secure Wi-Fi protocol (ideally WPA3) and a [strong password](https://www.mitnicksecurity.com/blog/password-security-best-practices).
