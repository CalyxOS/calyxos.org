...
<tr>
  ...
  <td>SUPL is an assistive GPS (A-GPS) service that allows the device to much more quickly get a GPS lock. Currently, the request for GPS satellite information that CalyxOS makes to Google servers ..</td>
</tr>
<tr>
