...
* Alternative app stores: Install open source apps with F-Droid or use the Google Play store anonymously with Aurora Store.
...
Aurora Store & F-Droid. CalyxOS comes with two app stores, F-Droid and the Aurora Store.
...
2) Copy it from your non-CalyxOS Android phone
* Steps to export from e Android Contacts app
...
Signal - Encrypted messaging Application. We suggest using Signal as your messaging app, as your messages will be encrypted when messaging other Signal users.
...
Ad/tracker-free, secure, browsing via select Bromite features in the privacy-enhanced CalyxOS Chromium browser
...
The Chromium that comes with CalyxOS is different from Google Chrome. It is heavily modified to prioritize privacy, and has more in common with Bromite, a privacy focused browser with ad blocking and many anti-tracking privacy enhancements.
...
Curious how well your browser of choice protects you compared to Chrome, Bromite, Firefox, Safari, Tor, and more? See https://privacytests.org for an overhead view of the various protections offered by your browser.
...
things that do work: most popular apps will work e.g. google maps, whatsapp, uber, lyft, Instagram, Spotify. https://en.wikipedia.org/wiki/List_of_most-downloaded_Google_Play_applications

=====================================

Key problems: Our developers are working on addressing several issues. You can find more information and report issues on our Matrix pages:

Aurora will try to update Google Play Services.

These issues and more are currently being worked on! Curious what changes, updates, and features are coming to CalyxOS? Check out: calyxos.org/news
