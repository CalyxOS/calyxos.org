...
<strong>[[Install => install]]</strong> / <strong>[[Moto G52 => rhode]]</strong> / <strong>Linux</strong>
...
<a class="btn" href="https://release.calyxinstitute.org/rhode-factory-24503020.zip">Download CalyxOS Image</a>
...
{% assign image = "https://release.calyxinstitute.org/rhode-factory-24503020.zip" | split: "/" | last %}
{% include install/linux_image_digest.md filename=image %}

And ensure the result says `329a7f8e4c15bf1f662e3caa599787fce00ae67dcb7f8115777636287cbbd8f6`. This is the unique digest of the image file. If it doesn't match, then you have a corrupted or incorrect file.

#### Verify Signature

For the highest level of confidence, you can optionally <a href="https://release.calyxinstitute.org/rhode-factory-24503020.zip.minisig">download the signature file</a> and then [[verify image signature => verify]].
