...
<strong>[[Install => install]]</strong> / <strong>[[Pixel 6a (beta) => bluejay]]</strong> / <strong>Windows</strong>
...
<a class="btn" href="https://release.calyxinstitute.org/bluejay-factory-22307032.zip">Download CalyxOS Image</a>
...
{% assign image = "https://release.calyxinstitute.org/bluejay-factory-22307032.zip" | split: "/" | last %}
{% include install/windows_image_digest.md filename=image %}

And ensure the result says `6f6bc3738331125e8c985d6edc2cda73374104207e92fd997bf101d1c886eb71`. This is the unique digest of the image file. If it doesn't match, then you have a corrupted or incorrect file.

#### Verify Signature

For the highest level of confidence, you can optionally <a href="https://release.calyxinstitute.org/bluejay-factory-22307032.zip.minisig">download the signature file</a> and then [[verify image signature => verify]].
...
{% if site.data.install.bluejay.unlock_notes %}
{% include {{site.data.install.bluejay.unlock_notes}} %}
{% endif %}
