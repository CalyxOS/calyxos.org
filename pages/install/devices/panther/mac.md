...
<strong>[[Install => install]]</strong> / <strong>[[Pixel 7 (beta) => panther]]</strong> / <strong>MacOS</strong>
...
<a class="btn" href="https://release.calyxinstitute.org/panther-factory-22402040.zip">Download CalyxOS Image</a>
...
{% assign image = "https://release.calyxinstitute.org/panther-factory-22402040.zip" | split: "/" | last %}
{% include install/mac_image_digest.md filename=image %}

And ensure the result says `582fcd88bb338571d179e0181a4aa6a1ef88be27e6587cdcf58535f9a444a40e`. This is the unique digest of the image file. If it doesn't match, then you have a corrupted or incorrect file.

#### Verify Signature

For the highest level of confidence, you can optionally <a href="https://release.calyxinstitute.org/panther-factory-22402040.zip.minisig">download the signature file</a> and then [[verify image signature => verify]].
...
{% if site.data.install.panther.unlock_notes %}
{% include {{site.data.install.panther.unlock_notes}} %}
{% endif %}
