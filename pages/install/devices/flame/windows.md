...
<strong>[[Install => install]]</strong> / <strong>[[Pixel 4 => flame]]</strong> / <strong><a href="#">Windows</a></strong>
...
Save this image in the same directory as device-flasher. This image will **only** work for **Pixel 4 (flame)**. Any attempt to install this image on a different device model my destroy the Android device.
