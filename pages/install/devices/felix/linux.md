...
<strong>[[Install => install]]</strong> / <strong>[[Pixel Fold (beta) => felix]]</strong> / <strong>Linux</strong>
...
<a class="btn" href="https://release.calyxinstitute.org/felix-factory-23411020.zip">Download CalyxOS Image</a>
...
{% assign image = "https://release.calyxinstitute.org/felix-factory-23411020.zip" | split: "/" | last %}
{% include install/linux_image_digest.md filename=image %}

And ensure the result says `f14940dca03a1d26d48d2a98e4c19c438e53802155762309f2cf0fd47846784f`. This is the unique digest of the image file. If it doesn't match, then you have a corrupted or incorrect file.

#### Verify Signature

For the highest level of confidence, you can optionally <a href="https://release.calyxinstitute.org/felix-factory-23411020.zip.minisig">download the signature file</a> and then [[verify image signature => verify]].
...
{% if site.data.install.felix.unlock_notes %}
{% include {{site.data.install.felix.unlock_notes}} %}
{% endif %}
