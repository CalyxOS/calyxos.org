...
<strong>[[Install => install]]</strong> / <strong>[[Fairphone 5 (Beta) => FP5]]</strong> / <strong>Windows</strong>
...
<a class="btn" href="https://release.calyxinstitute.org/FP5-factory-24504022.zip">Download CalyxOS Image</a>

Save this image in the same directory as device-flasher. This image will **only** work for **Fairphone 5 (Beta) (FP5)**. Any attempt to install this image on a different device model may brick (destroy) the Android device.
...
{% assign image = "https://release.calyxinstitute.org/FP5-factory-24504022.zip" | split: "/" | last %}
{% include install/windows_image_digest.md filename=image %}

And ensure the result says `269a4cdafd81afa917ca9167e5290a3028a4e0e526b9fbd42c81f2961404d989`. This is the unique digest of the image file. If it doesn't match, then you have a corrupted or incorrect file.

#### Verify Signature

For the highest level of confidence, you can optionally <a href="https://release.calyxinstitute.org/FP5-factory-24504022.zip.minisig">download the signature file</a> and then [[verify image signature => verify]].
...
{% if site.data.install.FP5.unlock_notes %}
{% include {{site.data.install.FP5.unlock_notes}} %}
{% endif %}
