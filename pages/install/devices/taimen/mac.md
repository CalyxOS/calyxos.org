...
<strong>[[Install => install]]</strong> / <strong>[[Pixel 2 XL => taimen]]</strong> / <strong>MacOS</strong>
...
Save this image in the same directory as device-flasher. This image will **only** work for **Pixel 2 XL (taimen)**. Any attempt to install this image on a different device model may destroy the Android device.
