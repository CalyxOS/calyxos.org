...
<strong>[[Install => install]]</strong> / <strong><a href="/install/devices/sunfish/">Pixel 4a</a></strong>
...
<a class="btn" href="https://release.calyxinstitute.org/sunfish-factory-25514020.zip">Download CalyxOS Image</a>

Save this image in the same directory as device-flasher. This image will **only** work for **Pixel 4a (sunfish)**. Any attempt to install this image on a different device model may brick (destroy) the Android device.
...
{% assign image = "https://release.calyxinstitute.org/sunfish-factory-25514020.zip" | split: "/" | last %}
{% include install/windows_image_digest.md filename=image %}

And ensure the result says `c9b46285d20d82bb95c862fbcf48ba42397f98274875b5fdf848e45cce1b9915`. This is the unique digest of the image file. If it doesn't match, then you have a corrupted or incorrect file.

#### Verify Signature

For the highest level of confidence, you can optionally <a href="https://release.calyxinstitute.org/sunfish-factory-25514020.zip.minisig">download the signature file</a> and then [[verify image signature => verify]].
...
{% if site.data.install.sunfish.unlock_notes %}
{% include {{site.data.install.sunfish.unlock_notes}} %}
{% endif %}
