...
<strong>[[Install => install]]</strong> / <strong>[[Pixel 4a (5G) => bramble]]</strong> / <strong>Windows</strong>

{% if site.data.install.bramble.arb %}
## IMPORTANT
...
<a class="btn" href="https://release.calyxinstitute.org/bramble-factory-22307002.zip">Download CalyxOS Image</a>
...
{% assign image = "https://release.calyxinstitute.org/bramble-factory-22307002.zip" | split: "/" | last %}
{% include install/windows_image_digest.md filename=image %}

And ensure the result says `73273bff6594513ba9191ecc5522d62f2664ddd10a679732e3387c9a145e108d`. This is the unique digest of the image file. If it doesn't match, then you have a corrupted or incorrect file.

#### Verify Signature

For the highest level of confidence, you can optionally <a href="https://release.calyxinstitute.org/bramble-factory-22307002.zip.minisig">download the signature file</a> and then [[verify image signature => verify]].
