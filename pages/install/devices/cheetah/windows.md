---
title: Install on Pixel 7 Pro (beta)
description: From a Windows computer
toc: true
---

<strong>[[Install => install]]</strong> / <strong>[[Pixel 7 Pro (beta) => cheetah]]</strong> / <strong>Windows</strong>
...
<a class="btn" href="https://release.calyxinstitute.org/cheetah-factory-22402070.zip">Download CalyxOS Image</a>

Save this image in the same directory as device-flasher. This image will **only** work for **Pixel 7 Pro (beta) (cheetah)**. Any attempt to install this image on a different device model may brick (destroy) the Android device.
...
{% assign image = "https://release.calyxinstitute.org/cheetah-factory-22402070.zip" | split: "/" | last %}
{% include install/windows_image_digest.md filename=image %}

And ensure the result says `bb6a845c611f876eef8de59761eb905cc2339f53b823b7da82232d218e0d40e0`. This is the unique digest of the image file. If it doesn't match, then you have a corrupted or incorrect file.

#### Verify Signature

For the highest level of confidence, you can optionally <a href="https://release.calyxinstitute.org/cheetah-factory-22402070.zip.minisig">download the signature file</a> and then [[verify image signature => verify]].
...
{% if site.data.install.cheetah.unlock_notes %}
{% include {{site.data.install.cheetah.unlock_notes}} %}
{% endif %}
