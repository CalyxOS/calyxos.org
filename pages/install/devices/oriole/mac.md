---
title: Install on Pixel 6
description: From a MacOS computer
toc: true
---

<strong>[[Install => install]]</strong> / <strong><a href="/install/devices/oriole/">Pixel 6</a></strong>
...
<a class="btn" href="https://release.calyxinstitute.org/oriole-factory-25606200.zip">Download CalyxOS Image</a>
...
{% assign image = "https://release.calyxinstitute.org/oriole-factory-25606200.zip" | split: "/" | last %}
{% include install/mac_image_digest.md filename=image %}

And ensure the result says `605e27388d705a0f9f6118e0e47627d1fa2fb2c23dcd48a972e8179458aa6497`. This is the unique digest of the image file. If it doesn't match, then you have a corrupted or incorrect file.

#### Verify Signature

For the highest level of confidence, you can optionally <a href="https://release.calyxinstitute.org/oriole-factory-25606200.zip.minisig">download the signature file</a> and then [[verify image signature => verify]].
...
{% if site.data.install.oriole.unlock_notes %}
{% include {{site.data.install.oriole.unlock_notes}} %}
{% endif %}
