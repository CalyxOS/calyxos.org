...
<strong>[[Install => install]]</strong> / <strong>[[SHIFT6mq => axolotl]]</strong> / <strong>Windows</strong>
...
<a class="btn" href="https://release.calyxinstitute.org/axolotl-factory-24417000.zip">Download CalyxOS Image</a>
...
{% assign image = "https://release.calyxinstitute.org/axolotl-factory-24417000.zip" | split: "/" | last %}
{% include install/windows_image_digest.md filename=image %}

And ensure the result says `6e56f2f4ddafcdab43478594967af0f2e01dee4e8f6697ad3eadfd3d7bd22055`. This is the unique digest of the image file. If it doesn't match, then you have a corrupted or incorrect file.

#### Verify Signature

For the highest level of confidence, you can optionally <a href="https://release.calyxinstitute.org/axolotl-factory-24417000.zip.minisig">download the signature file</a> and then [[verify image signature => verify]].
