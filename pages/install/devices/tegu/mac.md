---
title: Install on Pixel 9a
description: From a MacOS computer
toc: true
---

<strong>[[Install => install]]</strong> / <strong><a href="/install/devices/tegu/">Pixel 9a</a></strong>
...
<a class="btn" href="https://release.calyxinstitute.org/tegu-factory-25608110.zip">Download CalyxOS Image</a>


Save this image in the same directory as device-flasher. This image will **only** work for **Pixel 9a (tegu)**. Any attempt to install this image on a different device model may brick (destroy) the Android device.
...
{% assign image = "https://release.calyxinstitute.org/tegu-factory-25608110.zip" | split: "/" | last %}
{% include install/mac_image_digest.md filename=image %}

And ensure the result says `6897cfdfea5910f5d25a77c1e38c314ba877172f97f28939a2bfcdd745356dfa`. This is the unique digest of the image file. If it doesn't match, then you have a corrupted or incorrect file.

#### Verify Signature

For the highest level of confidence, you can optionally <a href="https://release.calyxinstitute.org/tegu-factory-25608110.zip.minisig">download the signature file</a> and then [[verify image signature => verify]].
...
{% if site.data.install.tegu.unlock_notes %}
{% include {{site.data.install.tegu.unlock_notes}} %}
{% endif %}
