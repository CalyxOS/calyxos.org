...
<strong>[[Install => install]]</strong> / <strong>[[Xiaomi Mi A2 => jasmine_sprout]]</strong> / <strong><a href="#">Windows</a></strong>
...
Save this image in the same directory as device-flasher. This image will **only** work for **Xiaomi Mi A2 (jasmine_sprout)**. Any attempt to install this image on a different device model my destroy the Android device.
