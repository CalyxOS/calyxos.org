...
<strong>[[Install => install]]</strong> / <strong>[[Xiaomi Mi A2 => jasmine_sprout]]</strong> / <strong>Windows</strong>
...
<a class="btn" href="https://release.calyxinstitute.org/jasmine_sprout-factory-22214000.zip">Download CalyxOS Image</a>
...
{% assign image = "https://release.calyxinstitute.org/jasmine_sprout-factory-22214000.zip" | split: "/" | last %}
{% include install/windows_image_digest.md filename=image %}

And ensure the result says `71fc0f94ece231a1b2a0ca604cdd4a4cfab54e69f45d5f2d8ae149b1ea9d7968`. This is the unique digest of the image file. If it doesn't match, then you have a corrupted or incorrect file.

#### Verify Signature

For the highest level of confidence, you can optionally <a href="https://release.calyxinstitute.org/jasmine_sprout-factory-22214000.zip.minisig">download the signature file</a> and then [[verify image signature => verify]].
