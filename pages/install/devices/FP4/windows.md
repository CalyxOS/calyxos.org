---
title: Install on Fairphone 4 (beta)
description: From a Windows computer
toc: true
---

<strong>[[Install => install]]</strong> / <strong>[[Fairphone 4 (beta) => FP4]]</strong> / <strong>Windows</strong>
...
<a class="btn" href="https://release.calyxinstitute.org/FP4-factory-22402020.zip">Download CalyxOS Image</a>

Save this image in the same directory as device-flasher. This image will **only** work for **Fairphone 4 (beta) (FP4)**. Any attempt to install this image on a different device model may brick (destroy) the Android device.
...
{% assign image = "https://release.calyxinstitute.org/FP4-factory-22402020.zip" | split: "/" | last %}
{% include install/windows_image_digest.md filename=image %}

And ensure the result says `e003d394ef0e222daaef8aabd6223b2b124936aad5555a9d9e17163ec8a9f970`. This is the unique digest of the image file. If it doesn't match, then you have a corrupted or incorrect file.

#### Verify Signature

For the highest level of confidence, you can optionally <a href="https://release.calyxinstitute.org/FP4-factory-22402020.zip.minisig">download the signature file</a> and then [[verify image signature => verify]].
...
{% if site.data.install..troubleshooting %}
{% include {{site.data.install..troubleshooting}} %}
{% endif %}
