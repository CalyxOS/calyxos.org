...
<strong>[[Install => install]]</strong> / <strong>[[Moto G42 => hawao]]</strong> / <strong>Windows</strong>
...
<a class="btn" href="https://release.calyxinstitute.org/hawao-factory-23415000.zip">Download CalyxOS Image</a>
...
{% assign image = "https://release.calyxinstitute.org/hawao-factory-23415000.zip" | split: "/" | last %}
{% include install/windows_image_digest.md filename=image %}

And ensure the result says `bf99df9a52ec9c4804a578b9835e54eb42d146d044deb0b0aac33ea247c2525c`. This is the unique digest of the image file. If it doesn't match, then you have a corrupted or incorrect file.

#### Verify Signature

For the highest level of confidence, you can optionally <a href="https://release.calyxinstitute.org/hawao-factory-23415000.zip.minisig">download the signature file</a> and then [[verify image signature => verify]].
...
{% if site.data.install.hawao.unlock_notes %}
{% include {{site.data.install.hawao.unlock_notes}} %}
{% endif %}
