...
<a class="btn" href="https://release.calyxinstitute.org/bangkk-factory-25607222.zip">Download CalyxOS Image</a>
...
{% assign image = "https://release.calyxinstitute.org/bangkk-factory-25607222.zip" | split: "/" | last %}
{% include install/mac_image_digest.md filename=image %}

And ensure the result says `585c0e8f297bfae1d867a0e23b1810670a3d416864977586a1f8fefaa6698b35`. This is the unique digest of the image file. If it doesn't match, then you have a corrupted or incorrect file.

#### Verify Signature

For the highest level of confidence, you can optionally <a href="https://release.calyxinstitute.org/bangkk-factory-25607222.zip.minisig">download the signature file</a> and then [[verify image signature => verify]].
