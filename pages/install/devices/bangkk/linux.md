...
{% assign image = "https://release.calyxinstitute.org/bangkk-factory-0.zip" | split: "/" | last %}
...
For the highest level of confidence, you can optionally <a href="https://release.calyxinstitute.org/bangkk-factory-0.zip.minisig">download the signature file</a> and then [[verify image signature => verify]].
