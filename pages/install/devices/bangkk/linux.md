...
<a class="btn" href="https://release.calyxinstitute.org/bangkk-factory-25607220.zip">Download CalyxOS Image</a>
...
{% assign image = "https://release.calyxinstitute.org/bangkk-factory-25607220.zip" | split: "/" | last %}
{% include install/linux_image_digest.md filename=image %}

And ensure the result says `6ab7098189ec5f21488d075149c6b44559f2be9b264418f804313057296c22a2`. This is the unique digest of the image file. If it doesn't match, then you have a corrupted or incorrect file.

#### Verify Signature

For the highest level of confidence, you can optionally <a href="https://release.calyxinstitute.org/bangkk-factory-25607220.zip.minisig">download the signature file</a> and then [[verify image signature => verify]].
