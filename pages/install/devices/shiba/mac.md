...
<strong>[[Install => install]]</strong> / <strong>[[Pixel 8 => shiba]]</strong> / <strong>MacOS</strong>
...
<a class="btn" href="https://release.calyxinstitute.org/shiba-factory-24503020.zip">Download CalyxOS Image</a>
...
{% assign image = "https://release.calyxinstitute.org/shiba-factory-24503020.zip" | split: "/" | last %}
{% include install/mac_image_digest.md filename=image %}

And ensure the result says `055844a0d32d3862f508e9ac797d6f404bd2c7fc8531eed643a182c005b7ca92`. This is the unique digest of the image file. If it doesn't match, then you have a corrupted or incorrect file.

#### Verify Signature

For the highest level of confidence, you can optionally <a href="https://release.calyxinstitute.org/shiba-factory-24503020.zip.minisig">download the signature file</a> and then [[verify image signature => verify]].
...
{% if site.data.install.shiba.unlock_notes %}
{% include {{site.data.install.shiba.unlock_notes}} %}
{% endif %}
