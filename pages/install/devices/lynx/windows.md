---
title: Install on Pixel 7a
description: From a Windows computer
toc: true
---

<strong>[[Install => install]]</strong> / <strong>[[Pixel 7a => lynx]]</strong> / <strong>Windows</strong>
...
<a class="btn" href="https://release.calyxinstitute.org/lynx-factory-23501020.zip">Download CalyxOS Image</a>
...
{% assign image = "https://release.calyxinstitute.org/lynx-factory-23501020.zip" | split: "/" | last %}
{% include install/windows_image_digest.md filename=image %}

And ensure the result says `ff80bf7aa43dfea59da482a2a1f348801bdef154de05573a42270a85724380ff`. This is the unique digest of the image file. If it doesn't match, then you have a corrupted or incorrect file.

#### Verify Signature

For the highest level of confidence, you can optionally <a href="https://release.calyxinstitute.org/lynx-factory-23501020.zip.minisig">download the signature file</a> and then [[verify image signature => verify]].
...
{% if site.data.install.lynx.unlock_notes %}
{% include {{site.data.install.lynx.unlock_notes}} %}
{% endif %}
