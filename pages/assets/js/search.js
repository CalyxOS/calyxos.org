...
(function () {
  ...
  // {% assign site_contents_file = 'sitecontents-' | append: site_timestamp | append: '.json' %}
  const SITE_CONTENTS_FILE = "{{site_contents_file}}";
  const SITE_CONTENTS_URL =
    "{{ '/assets/' | append: site_contents_file | relative_url }}";
