(function (global, factory) {
  ...
  var MiniSearch = /** @class */ (function () {
    ...
    MiniSearch.prototype.discard = function (id) {
      ...
      this._documentIds.delete(shortId);
      this._storedFields.delete(shortId);
      (this._fieldLength.get(shortId) || []).forEach(function (
        fieldLength,
        fieldId
      ) {
    ...
    MiniSearch.prototype.maybeAutoVacuum = function () {
      ...
      this.conditionalVacuum(
        ...
        { minDirtCount: minDirtCount, minDirtFactor: minDirtFactor }
      );
    };
    /**
      ...
      try {
        ...
        try {
          if (
            combinedResults_1_1 &&
            !combinedResults_1_1.done &&
            (_a = combinedResults_1.return)
          )
            _a.call(combinedResults_1);
        } finally {
    ...
    MiniSearch.prototype.executeQuery = function (query, searchOptions) {
      ...
      var options = __assign(
        __assign(
          { tokenize: tokenize, processTerm: processTerm },
          globalSearchOptions
        ),
        searchOptions
      );
    ...
    MiniSearch.prototype.executeQuerySpec = function (query, searchOptions) {
      ...
      var boosts = (options.fields || this._options.fields).reduce(function (
        ...
        return __assign(
          __assign({}, boosts),
          ((_a = {}),
          (_a[field] = getOwnProperty(options.boost, field) || 1),
          _a)
        );
      },
      {});
        ...
        try {
          ...
          try {
            if (
              prefixMatches_1_1 &&
              !prefixMatches_1_1.done &&
              (_a = prefixMatches_1.return)
            )
              _a.call(prefixMatches_1);
          } finally {
     ...
     * @ignore
     */
    MiniSearch.prototype.termResults = function (
      sourceTerm,
      derivedTerm,
      termWeight,
      fieldTermData,
          ...
          try {
            for (
              ...
              var docBoost = boostDocumentFn
                ? boostDocumentFn(this._documentIds.get(docId), derivedTerm)
                : 1;
     ...
     * @ignore
     */
    MiniSearch.prototype.warnDocumentChanged = function (
      shortDocumentId,
      fieldId,
      term
    ) {
     ...
     * @ignore
     */
    MiniSearch.prototype.addFieldLength = function (
      documentId,
      fieldId,
      count,
      length
     ...
     * @ignore
     */
    MiniSearch.prototype.removeFieldLength = function (
      documentId,
      fieldId,
      count,
      length
      ...
      try {
        ...
        try {
          if (
            storeFields_1_1 &&
            !storeFields_1_1.done &&
            (_a = storeFields_1.return)
          )
            _a.call(storeFields_1);
        } finally {
