...
Despite these challenges, we have good news. We have made the decision to further extend our device support for moto g32, g42, g52, Pixel 5, 4a 5G, and Pixel 5a 5G when CalyxOS resumes update releases. That means people with these devices can install the Android 16 version of CalyxOS when it becomes available. We are still gauging whether we can ship QPR1 to these extended release devices, pending the release of the QPR1 source; QPR2 is even less certain as we assess the work involved. We have updated the [EOL date for these devices](https://calyxos.org/docs/guide/device-support/) to the date of our next release at the end of 2025 or beginning of 2026.
