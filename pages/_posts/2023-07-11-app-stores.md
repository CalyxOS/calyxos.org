...
F-Droid Basic 1.17-alpha1 is [now available](https://f-droid.org/packages/org.fdroid.basic/), with:
* `targetSdk` set to 33 (Android 13), and a bump to 34 (Android 14) planned soon
* Confirm updates to install once per app, after that they'll install automatically in the background
