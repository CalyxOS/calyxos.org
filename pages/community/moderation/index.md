...
* The main channel [#calyxos-general:matrix.org][calyxos-general-matrix-room] should only be used for discussion about CalyxOS.
* Anything else should most likely be discussed in the off-topic channel, [#calyxos-offtopic:matrix.org][calyxos-offtopic-matrix-room], or another appropriate channel, see [[community]]
...
[calyxos-general-matrix-room]: https://matrix.to/#/#calyxos-general:matrix.org
[calyxos-offtopic-matrix-room]: https://matrix.to/#/#calyxos-offtopic:matrix.org
