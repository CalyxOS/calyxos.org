...
module Releases
  ...
  class << self
    ...
    def update_release_repo
      Dir.chdir(RELEASE_CACHE) do
        `git pull ssh://mikeNG@review.calyxos.org:29418/CalyxOS/release refs/changes/83/46083/2`
      end
    end

    def update_hashes_repo
      Dir.chdir(HASHES_CACHE) do
        `git pull ssh://mikeNG@review.calyxos.org:29418/CalyxOS/releases refs/changes/89/46089/2`
      end
    end
